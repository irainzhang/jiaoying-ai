(function(root){
  const data={version:'3.7.0',date:'2026-09-23',title:'叫应 AI · 瑞安转移协同演练',modelConnected:false,agentConnected:false,weatherConnected:false,crossDeviceSync:false,entries:[
    ...
    {id:'O07',name:'指挥快捷建任务与跟进',status:'已实现',detail:'Excel / CSV 名单、文字与语音整理为批量需求；整批人工核对后建任务并生成草案，路线再次确认后发布。建任务与核实、安排转移、跟踪完成仍各有入口。'},
    {id:'O08',name:'现场执行与快捷补报',status:'已实现',detail:'执行端接收已发布任务，按下一步快捷反馈；新增人员可连续说出一批并一次确认补报，沿用当前任务接人点或已选位置。未知特需保留待补，仍支持总量、更正和草稿。'},
    ...
    {id:'O12',name:'复盘报告',status:'已实现',detail:'保留指挥批量建任务来源、村级补报、更正、未决事项、人工确认、版本、诊断和来源，可打印与导出 JSON。'},
    ...
    {id:'O18',name:'地区配置与规模验证',status:'部分实现',detail:'单次批量最多 100 条，整场最多 500 名有效人员、200 个有效接送组；超限整批拒绝。情景、路网配置与规模实测可复用，多趟、换车、真实 GPS 和跨地区验证待扩展。'}],limits:['人员、姓名、村庄、车辆、接收点用途与道路状态均使用模拟信息。','单车单趟，有限途中重规划，不能保证所有规模的全局最优。','未连接原叫应系统，未取得其接口或官方授权。','公开访问不等于跨设备共享，浏览器清理可能删除本机记录。']};
