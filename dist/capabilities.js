(function(root){
  const data={version:'3.5.0',date:'2026-09-23',title:'叫应 AI · 瑞安转移协同演练',modelConnected:false,agentConnected:false,weatherConnected:false,crossDeviceSync:false,entries:[
    ...
    {id:'O07',name:'指挥待办与跟进',status:'已实现',detail:'集中显示待核实、待补、待联系、受阻与未安排；负责人和回执不代替业务核验。'},
    {id:'O08',name:'村级上报易用性',status:'已实现',detail:'区分新增/当前总数/更正，原话可核对，更改字段高亮，未提交草稿独立保存。'},
