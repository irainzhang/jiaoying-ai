...
1. 在指挥台打开“3 分钟演示引导”，从初始情景比较覆盖、逐车分配与接收点余位。
2. 同浏览器打开现场页，选择村庄与集合点，输入“新增12人，其中3人需协助，包含1名轮椅人员，可以分组”，核对卡片并确认。
3. 指挥台核实后更新台账与草案；未补信息、容量不足及尚未联系持续留在待办。
4. 选择“瑞安真实道路”情景可查看真实几何路线。点选路段上报阻断，核实后重算；恢复道路须登记障碍排除。
5. “登记资源变化”模拟车辆故障或接收点停用；比较改变与保留内容。草案需人工确认，已上车保持原车。
6. 登记联系、执行与到达，人工核验。导出报告与 JSON，使用“备份与恢复”校验导入。加载情景会替换当前演练，先导出要保留的记录。
