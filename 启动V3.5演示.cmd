@echo off
setlocal
set "JIAOYING_PORT=8769"
set "JIAOYING_STATE_FILE="
if not exist "%~dp0tmp\local-state-v35.json" if exist "%~dp0tmp\before-v35-live.json" set "JIAOYING_STATE_FILE=%~dp0tmp\before-v35-live.json"
set "JIAOYING_NODE="
